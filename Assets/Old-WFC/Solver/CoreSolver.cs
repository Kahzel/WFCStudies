...
namespace WaveFunctionCollapse
{
    public class CoreSolver
    {
        ...
        public CoreSolver(OutputGrid outputGrid, PatternManager patternManager)
        {
            ...
            propagationHelper = new PropragationHelper(this.outputGrid, coreHelper);
        }
        ...
        private void RemoveImpossibleNeighbours(VectorPair propagatePair, HashSet<int> possibleValuesAtNeighbour)
        {
            ...
            {
                var possibleNeighboursForBase = patternManager.GetNeighboursForPatternAtDirection(patternIndexAtBase, propagatePair.DirectionFromBase);
